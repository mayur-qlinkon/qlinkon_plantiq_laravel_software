...
class UpdateGrowingSpaceTypeRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        $typeId = $this->route('growing_space_type')?->id;

        return [
            'name' => [
                'required', 'string', 'max:255',
                Rule::unique('production_growing_space_types', 'name')->where('company_id', $companyId)->ignore($typeId),
            ],
