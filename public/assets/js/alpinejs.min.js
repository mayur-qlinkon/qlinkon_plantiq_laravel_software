(() => {
    ...
    function Ot(t, e) {
        let r = !0,
            ...
            i = D(() => {
                let o = t();
                if (
                    (JSON.stringify(o), !r && (typeof o == "object" || o !== n))
                ) {
                    let s = n;
                    queueMicrotask(() => {
                        e(o, s);
    ...
    function _e(t) {
        ...
        for (let o of r)
            e.some((s) => s.contains(o)) || nr.forEach((s) => s(o));
...
`
    ...
    d(
        ...
        (t, { value: e, modifiers: r, expression: n }, { evaluate: i }) => {
            (typeof n == "function" && (n = i(n)),
                n !== !1 &&
                    (!n || typeof n == "boolean" ? ai(t, r, e) : si(t, n, e)));
        },
    );
    function si(t, e, r) {
        (Lr(t, xt, ""),
    ...
    y(
        "refs",
        (t) => (
            t._x_refs_proxy || (t._x_refs_proxy = I(to(t))),
            t._x_refs_proxy
        ),
    );
    function to(t) {
    ...
    function Rn(t) {
        ...
        return (
            e || w(`Cannot find x-teleport element for selector: "${t}"`),
            e
        );
    }
    var Mn = () => {};
    ...
    function ao(t, e) {
        ...
        if (r.includes("debounce")) {
            ...
            r.splice(
                o,
                ee((r[o + 1] || "invalid-wait").split("ms")[0]) ? 2 : 1,
            );
        }
        if (r.includes("throttle")) {
            ...
            if (
                ...
                let _ = V(t.form, "reset", [], (f) => {
                    lt(
                        () =>
                            t._x_model &&
                            t._x_model.set(re(t, e, { target: t }, c())),
                    );
                });
                i(() => _());
            }
        ...
        r((s) => {
            ...
            if (i(s))
                s = Object.entries(s).map(([f, m]) => {
                    ...
                    (n(
                        (E) => {
                            (u.includes(E) && w("Duplicate key on x-for", t),
                                u.push(E));
                        },
                        { scope: { index: f, ...b } },
                    ),
                ...
                for (let f = 0; f < s.length; f++) {
                    ...
                    (n(
                        (b) => {
                            (u.includes(b) && w("Duplicate key on x-for", t),
                                u.push(b));
                        },
                        { scope: { index: f, ...m } },
                    ),
