...
!(function (t, e) {
    ...
    var a = {
            ...
            supportsInputEvents:
                ...
                ["data", "getTargetRanges", "inputType"].every((t) => t in InputEvent.prototype),
        },
    ...
    const L = function () {
        ...
        _ = {
            ...
            pickFiles(t) {
                const e = T("input", { type: "file", multiple: !0, hidden: !0, id: this.fileInputId });
    ...
    var j = { removeBlankTableCells: !1, tableCellSeparator: " | ", tableRowSeparator: "\n" },
        W = {
            bold: {
                tagName: "strong",
                inheritable: !0,
    ...
    class q {
        static proxyMethod(t) {
            const { name: e, toMethod: i, toProperty: n, optional: r } = H(t);
            this.prototype[e] = function () {
                let t, o;
                var s, a;
                i
                    ? (o = r ? (null === (s = this[i]) || void 0 === s ? void 0 : s.call(this)) : this[i]())
                    : n && (o = this[n]);
                return r
                    ? ((t = null === (a = o) || void 0 === a ? void 0 : a[e]), t ? J.call(t, o, arguments) : void 0)
    ...
    const Z = 1 === (null === (G = Array.from) || void 0 === G ? void 0 : G.call(Array, "👼").length),
        ...
        tt = " 👼" === (null === (X = String.fromCodePoint) || void 0 === X ? void 0 : X.call(String, 32, 128124));
    let et, it;
    ((et =
        Z && Q
    ...
    class ie extends q {
        ...
        findOrCreateCachedChildView(t, e, i) {
            ...
            return (
                n ? this.recordChildView(n) : ((n = this.createChildView(...arguments)), this.cacheViewForObject(n, e)),
                n
            );
        }
        createChildView(t, e) {
    ...
    const Fe = ce([
        ...
        Ge = ue(/^data-[\-\w.\u00B7-\uFFFF]+$/),
        Ye = ue(/^aria-[\-\w]+$/),
        Xe = ue(/^(?:(?:(?:f|ht)tps?|mailto|tel|callto|sms|cid|xmpp):|[^a-z]|[a-z+.\-]+(?:[^a-z+.\-:]|$))/i),
        $e = ue(/^(?:\w+script|data):/i),
        Ze = ue(/[\u0000-\u0020\u00A0\u1680\u180E\u2000-\u2029\u205F\u3000]/g),
        Qe = ue(/^html$/i),
        ti = ue(/^[a-z][.\w]*(-[.\w]+)+$/i);
    ...
    var li = (function t() {
        ...
        const i = (e) => t(e);
        if (((i.version = "3.2.5"), (i.removed = []), !e || !e.document || e.document.nodeType !== si || !e.Element))
        ...
        let x,
            C = "";
        const { implementation: E, createNodeIterator: S, createDocumentFragment: R, getElementsByTagName: k } = n,
            { importNode: T } = r;
        let w = {
        ...
        let ut = null;
        const ht = De({}, ["audio", "video", "img", "source", "image", "track"]);
        let dt = null;
        const gt = De({}, [
                "alt",
                "class",
        ...
        let bt = ft,
            vt = !1,
            At = null;
        const yt = De({}, [mt, pt, ft], ye);
        let xt = De({}, ["mi", "mo", "mn", "ms", "mtext"]),
            Ct = De({}, ["annotation-xml"]);
        const Et = De({}, ["title", "style", "font", "a", "script"]);
        let St = null;
        ...
        const wt = n.createElement("form"),
            ...
            Dt = function () {
                ...
                if (!Tt || Tt !== t) {
                    if (
                        ((t && "object" == typeof t) || (t = {}),
                        (t = Ie(t)),
                        (St = -1 === Rt.indexOf(t.PARSER_MEDIA_TYPE) ? "text/html" : t.PARSER_MEDIA_TYPE),
                        (kt = "application/xhtml+xml" === St ? ye : Ae),
                        (_ = Re(t, "ALLOWED_TAGS") ? De({}, t.ALLOWED_TAGS, kt) : j),
                        (W = Re(t, "ALLOWED_ATTR") ? De({}, t.ALLOWED_ATTR, kt) : U),
                        (At = Re(t, "ALLOWED_NAMESPACES") ? De({}, t.ALLOWED_NAMESPACES, ye) : yt),
                        (dt = Re(t, "ADD_URI_SAFE_ATTR") ? De(Ie(gt), t.ADD_URI_SAFE_ATTR, kt) : gt),
                        (ut = Re(t, "ADD_DATA_URI_TAGS") ? De(Ie(ht), t.ADD_DATA_URI_TAGS, kt) : ht),
                        (lt = Re(t, "FORBID_CONTENTS") ? De({}, t.FORBID_CONTENTS, kt) : ct),
                        (z = Re(t, "FORBID_TAGS") ? De({}, t.FORBID_TAGS, kt) : {}),
                        (q = Re(t, "FORBID_ATTR") ? De({}, t.FORBID_ATTR, kt) : {}),
                        (at = !!Re(t, "USE_PROFILES") && t.USE_PROFILES),
                        ...
                        t.CUSTOM_ELEMENT_HANDLING &&
                            ...
                            (V.attributeNameCheck = t.CUSTOM_ELEMENT_HANDLING.attributeNameCheck),
                        t.CUSTOM_ELEMENT_HANDLING &&
                        ...
                        at &&
                            ((_ = De({}, We)),
                            (W = []),
                            !0 === at.html && (De(_, Fe), De(W, Ue)),
                            !0 === at.svg && (De(_, Pe), De(W, Ve), De(W, qe)),
                            !0 === at.svgFilters && (De(_, Me), De(W, Ve), De(W, qe)),
                            !0 === at.mathMl && (De(_, _e), De(W, ze), De(W, qe))),
                        t.ADD_TAGS && (_ === j && (_ = Ie(_)), De(_, t.ADD_TAGS, kt)),
                        t.ADD_ATTR && (W === U && (W = Ie(W)), De(W, t.ADD_ATTR, kt)),
                        t.ADD_URI_SAFE_ATTR && De(dt, t.ADD_URI_SAFE_ATTR, kt),
                        t.FORBID_CONTENTS && (lt === ct && (lt = Ie(lt)), De(lt, t.FORBID_CONTENTS, kt)),
                        ot && (_["#text"] = !0),
                        $ && De(_, ["html", "head", "body"]),
                        _.table && (De(_, ["tbody"]), delete z.tbody),
                        ...
                        (void 0 === x &&
                            (x = (function (t, e) {
                                ...
                                try {
                                    return t.createPolicy(r, { createHTML: (t) => t, createScriptURL: (t) => t });
                                } catch (t) {
            ...
            Pt = function (t) {
                ...
                return (
                    ...
                    bt === ft ? k.call(e, $ ? "html" : "body")[0] : $ ? e.documentElement : o
                );
            },
            Mt = function (t) {
                return S.call(
        ...
        const Wt = function (t) {
                ...
                if (X && t.nodeType === oi && ke(/<[/\w]/g, t.data)) return (Ot(t), !0);
                if (!_[n] || z[n]) {
                    if (!z[n] && Vt(n)) {
                ...
                return t instanceof c &&
                    ...
                    : ("noscript" !== n && "noembed" !== n && "noframes" !== n) ||
                      ...
                      ? (Y &&
                            ...
                            t.textContent !== e && (be(i.removed, { element: t.cloneNode() }), (t.textContent = e))),
                ...
                if (J && !q[e] && ke(I, e));
                    ...
                    if (!(
                        (Vt(t) &&
                            ...
                            ((V.attributeNameCheck instanceof RegExp && ke(V.attributeNameCheck, e)) ||
                                (V.attributeNameCheck instanceof Function && V.attributeNameCheck(e)))) ||
                        ("is" === e &&
                            V.allowCustomizedBuiltInElements &&
            ...
            zt = function (t) {
                ...
                if (!e || Bt(t)) return;
                const n = { attrName: "", attrValue: "", keepAttr: !0, allowedAttributes: W, forceKeepAttr: void 0 };
                let r = e.length;
                for (; r--;) {
                    const o = e[r],
                    ...
                    if (
                        ...
                        (u = n.attrValue),
                        !rt || ("id" !== c && "name" !== c) || (Ft(s, t), (u = "user-content-" + u)),
                        X && ke(/((--!?|])>)|<\/(style|title)/i, u))
                    ) {
                        Ft(s, t);
                        continue;
                    }
            ...
            (i.sanitize = function (t) {
                ...
                if ((Z || Dt(e), (i.removed = []), "string" == typeof t && (st = !1), st)) {
                    if (t.nodeName) {
                        ...
                        if (!_[e] || z[e]) throw Te("root node is forbidden and cannot be sanitized in-place");
                    }
                    ...
                    if (!tt && !Y && !$ && -1 === t.indexOf("<")) return x && it ? x.createHTML(t) : t;
                ...
                if (st) return t;
                if (tt) {
                    if (et) for (c = R.call(n.ownerDocument); n.firstChild;) c.appendChild(n.firstChild);
                    else c = n;
    ...
    class pi extends ie {
        ...
        createNodes() {
            ...
            const e = (t = T({
                ...
                i = this.getHref();
            return (
                i && ((t = T({ tagName: "a", editable: !1, attributes: { href: i, tabindex: -1 } })), e.appendChild(t)),
        ...
        createCaptionElement() {
            ...
            if (e) (t.classList.add("".concat(mi.attachmentCaption, "--edited")), (t.textContent = e));
            else {
                let e, i;
                ...
                if (
                    ...
                    const i = T({ tagName: "span", className: mi.attachmentName, textContent: e });
                    t.appendChild(i);
                }
                if (i) {
                    e && t.appendChild(document.createTextNode(" "));
                    const n = T({ tagName: "span", className: mi.attachmentSize, textContent: i });
                    t.appendChild(n);
                }
            }
            return t;
        ...
        getClassName() {
            const t = [mi.attachment, "".concat(mi.attachment, "--").concat(this.attachment.getType())],
    ...
    const fi = (t) => T({ tagName: "span", textContent: d, data: { trixCursorTarget: t, trixSerialize: !1 } }),
        bi = function (t, e) {
            const i = T("div");
    ...
    class vi extends pi {
        ...
        createContentNodes() {
            return (
                (this.image = T({ tagName: "img", attributes: { src: "" }, data: { trixMutable: !0 } })),
        ...
        preserveSpaces(t) {
            return (
                ...
                (t = t
                    ...
                    .replace(/\ {2}/g, " ".concat(g))),
                (this.context.isFirst || this.context.followsWhitespace) && (t = t.replace(/^\ /, g)),
                t
            );
        }
    }
    class yi extends ie {
        ...
        createNodes() {
            ...
            for (let r = 0; r < e.length; r++) {
                const o = e[r],
                    s = {};
                (0 === r && (s.isFirst = !0), r === i && (s.isLast = !0), xi(n) && (s.followsWhitespace = !0));
                const a = this.findOrCreateCachedChildView(Ai, o, { textConfig: this.textConfig, context: s });
    ...
    class Ei extends ie {
        ...
        createNodes() {
            ...
            if (this.block.isEmpty()) t.push(T("br"));
                ...
                const i = null === (e = mt(this.block.getLastAttribute())) || void 0 === e ? void 0 : e.text,
                    n = this.findOrCreateCachedChildView(yi, this.block.text, { textConfig: i });
        ...
        createContainerElement(t) {
            ...
            if ((0 === t && this.block.isRTL() && Object.assign(e, { dir: "rtl" }), "attachmentGallery" === n)) {
                const t = this.block.getBlockBreakPosition();
                i = "".concat(Ci.attachmentGallery, " ").concat(Ci.attachmentGallery, "--").concat(t);
            }
            return (
    ...
    class Hi extends rt {
        ...
        splitObjectsAtRange(t) {
            ...
            return (([i, e] = new this.constructor(i).splitObjectAtPosition(Gi(t) + r)), [i, n, e - 1]);
        }
        ...
        isEqualTo(t) {
            return super.isEqualTo(...arguments) || Ji(this.objects, null == t ? void 0 : t.objects);
        }
        contentsForInspection() {
    ...
    class Yi extends rt {
        ...
        addAttributesAtRange(t, e) {
            return this.copyWithPieceList(
                this.pieceList.transformObjectsInRange(e, (e) => e.copyWithAdditionalAttributes(t)),
            );
        }
        ...
        getAttributesAtPosition(t) {
            var e;
            return (
                (null === (e = this.pieceList.getObjectAtPosition(t)) || void 0 === e ? void 0 : e.getAttributes()) ||
                {}
            );
        }
        getCommonAttributes() {
    ...
    const $i = function (t) {
        ...
        Zi = function (t) {
            ...
            return r ? ((n = n.map((t) => (t.isBlockBreak() ? ((e = !0), nn(t)) : t))), e ? new Yi([...n, r]) : t) : t;
        },
    ...
    class an extends rt {
        ...
        constructor() {
            let t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : [];
            (super(...arguments), 0 === t.length && (t = [new Xi()]), (this.blockList = Hi.box(t)));
        }
        isEmpty() {
        ...
        moveTextFromRangeToPosition(t, e) {
            ...
            return (
                ...
                0 === c.length
                    ? s
                    : ((o = new this.constructor(c)), (e += i.getLength()), s.insertDocumentAtRange(o, e))
            );
        }
        addAttributeAtRange(t, e, i) {
        ...
        addAttribute(t, e) {
            ...
            return (
                this.eachBlock((n, r) => (i = i.editObjectAtIndex(r, () => n.addAttribute(t, e)))),
            ...
            return (
                this.eachBlockAtRange(e, function (e, n, r) {
                    mt(t)
                        ...
                        : n[0] !== n[1] &&
                          (i = i.editObjectAtIndex(r, () => e.copyWithText(e.text.removeAttributeAtRange(t, n))));
                }),
                new this.constructor(i)
            );
        }
        ...
        insertBlockBreakAtRange(t) {
            ...
            return (
                0 === n && (e = [new Xi()]),
                new this.constructor(r.blockList.insertSplittableListAtPosition(new Hi(e), i))
            );
        }
        ...
        eachBlockAtRange(t, e) {
            ...
            if (s.index === a.index)
                return ((i = this.getBlockAtIndex(s.index)), (n = [s.offset, a.offset]), e(i, n, s.index));
            ...
            if (Lt(t)) return this.getCommonAttributesAtPosition(e);
            {
                ...
                return (
                    this.eachBlockAtRange(t, function (t, n) {
                        if (n[0] !== n[1]) return (e.push(t.text.getCommonAttributesAtRange(n)), i.push(ln(t)));
                    }),
    ...
    class hn extends q {
        ...
        parse() {
            try {
                (this.createHiddenContainer(),
                    di.setHTML(this.containerElement, this.html, { purifyOptions: this.purifyOptions }));
        ...
        createHiddenContainer() {
            return this.referenceElement
                ...
                : ((this.containerElement = T({ tagName: "div", style: { display: "none" } })),
        ...
        appendBlockForTextNode(t) {
            ...
            if (e === this.containerElement || this.isBlockElement(e)) {
                ...
                ot(t, null === (i = this.currentBlock) || void 0 === i ? void 0 : i.attributes) ||
                    ((this.currentBlock = this.appendBlockForAttributesWithElement(t, e, n)),
            ...
            if (e && !this.isBlockElement(t.firstChild)) {
                if (!this.isInsignificantTextNode(t.firstChild) || !this.isBlockElement(t.firstElementChild)) {
                    ...
                    if (t.firstChild) {
                        ...
                        ((this.currentBlock = this.appendBlockForAttributesWithElement(e, t, n)),
        ...
        processTextNode(t) {
            ...
            dn(t.parentNode) ||
                ((e = Vt(e)),
                vn(null === (i = t.previousSibling) || void 0 === i ? void 0 : i.textContent) && (e = fn(e)));
        ...
        getTextAttributes(t) {
            ...
            for (const n in W) {
                const r = W[n];
                if (r.tagName && y(t, { matchingSelector: r.tagName, untilNode: this.containerElement })) i[n] = !0;
                else if (r.parser) {
                    if (((e = r.parser(t)), e)) {
                        let o = !1;
        ...
        isInsignificantTextNode(t) {
            ...
            return (gn(e.previousSibling) && !this.isBlockElement(e.previousSibling)) || dn(e)
                ? void 0
    ...
    class kn extends q {
        ...
        manageAttachment(t) {
            return (
                this.managedAttachments[t.id] || (this.managedAttachments[t.id] = new Rn(this, t)),
    ...
    class wn extends q {
        ...
        insertBlock() {
            let t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : new Xi();
            const e = new an([t]);
        ...
        insertHTML(t) {
            const e = hn.parse(t, { purifyOptions: { SAFE_FOR_XML: !0 } }).getDocument(),
        ...
        replaceHTML(t) {
            const e = hn.parse(t).getDocument().copyUsingObjectsFromDocument(this.document),
        ...
        canIncreaseNestingLevel() {
            ...
            const e = this.getBlock();
            if (e) {
                if (null === (t = mt(e.getLastNestableAttribute())) || void 0 === t || !t.listAttribute)
                    return e.getNestingLevel() > 0;
                {
                    ...
                    if (t)
                        return (function () {
                            ...
                            return ot(
                                (arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : []).slice(
                                    0,
                                    t.length,
                                ),
                                t,
        ...
        getLocationRange(t) {
            return this.targetLocationRange
                ...
                : this.getSelectionManager().getLocationRange(t) || wt({ index: 0, offset: 0 });
        }
        ...
        breakFormattedBlock(t) {
            ...
            i.getBlockBreakPosition() === t.startLocation.offset
                ? (i.breaksOnReturn() && "\n" === t.nextCharacter ? (n += 1) : (e = e.removeTextAtRange(r)),
                  (r = [n, n]))
                : "\n" === t.nextCharacter
                  ? "\n" === t.previousCharacter
                      ? (r = [n - 1, n + 1])
    ...
    class In {
        ...
        removeBlockAttribute() {
            return this.findRangesOfBlocks().map((t) => (this.document = this.document.removeAttributeAtRange(Nn, t)));
        }
        applyBlockAttribute() {
            let t = 0;
    ...
    class Pn {
        ...
        loadJSON(t) {
            ...
            return ((e = an.fromJSON(e)), this.loadSnapshot({ document: e, selectedRange: i }));
        }
        loadSnapshot(t) {
    ...
    class Mn {
        ...
        findLocationFromContainerAndOffset(t, e) {
            ...
            for (; a.nextNode();) {
                ...
                N(s, { strict: i }) ? (r && o.index++, (o.offset = 0), (r = !0)) : (o.offset += Bn(s));
            }
            return o;
        }
        findContainerAndOffsetFromLocation(t) {
            ...
            if (n) {
                if (B(n))
                    0 === Bn(n)
                        ? ((e = n.parentNode.parentNode), (i = E(n.parentNode)), F(n, { name: "right" }) && i++)
                        : ((e = n), (i = t.offset - r));
                else {
    ...
    class Vn extends q {
        constructor(t) {
            (super(...arguments),
                ...
                (this.lockCount = 0),
                b("mousedown", { onElement: this.element, withCallback: this.didMouseDown }));
        }
        getLocationRange() {
            let t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};
            return !1 === t.strict
        ...
        pauseTemporarily() {
            ...
            const e = () => {
                ...
                i = setTimeout(e, 200);
            t = ["mousemove", "keydown"].map((t) => b(t, { onElement: document, withCallback: e }));
        }
        selectionDidChange() {
        ...
        updateCurrentLocationRange(t) {
            var e, i;
            if ((null != t ? t : (t = this.createLocationRangeFromDOMRange(Mt()))) && !Dt(t, this.currentLocationRange))
                return (
    ...
    const { lang: Hn, css: Jn, keyNames: Kn } = z,
        Gn = function (t) {
            return function () {
                ...
                Di(
                    ...
                    Gn(() => {
                        const t = T({
                            ...
                            attributes: { placeholder: Hn.captionPlaceholder },
                            data: { trixMutable: !0 },
                        });
                        ...
                        (b("input", { onElement: t, withCallback: i }),
                            ...
                            b("keydown", { onElement: t, withCallback: this.didKeyDownCaption }),
    ...
    class Xn extends q {
        constructor(t, i) {
            (super(...arguments),
                ...
                (this.element = t),
                (this.composition = i),
                (this.documentView = new Si(this.composition.document, { element: this.element })),
                ...
                b("mousedown", { onElement: this.element, matchingSelector: e, withCallback: this.didClickAttachment }),
                b("click", { onElement: this.element, matchingSelector: "a".concat(e), preventDefault: !0 }));
        }
        didFocus(t) {
            var e;
            const i = () => {
    ...
    const Zn = "data-trix-mutable",
        Qn = "[".concat(Zn, "]"),
        tr = { attributes: !0, childList: !0, characterData: !0, characterDataOldValue: !0, subtree: !0 };
    class er extends q {
        constructor(t) {
            (super(t),
            ...
            if (i.length) {
                const n = i[0],
                    ...
                    o = (function (t, e) {
                        ...
                        return (
                            (t = $.box(t)),
                            (e = $.box(e)).length < t.length ? ([n, i] = zt(t, e)) : ([i, n] = zt(e, t)),
                            { added: i, removed: n }
                        );
    ...
    class rr {
        ...
        previousEventWasUnidentifiedKeydown() {
            var t, e;
            return (
                "keydown" === (null === (t = this.previousEvent) || void 0 === t ? void 0 : t.type) &&
                "Unidentified" === (null === (e = this.previousEvent) || void 0 === e ? void 0 : e.key)
            );
        }
    }
    ...
    (Di(gr, "events", {
            ...
            if (e) {
                ...
                (["ctrl", "alt", "shift", "meta"].forEach((e) => {
                    ...
                    null != (null === (i = n) || void 0 === i ? void 0 : i[e]) &&
                        (this.setInputSummary({ keyName: e }), Ft.reset(), n[e].call(this, t)));
            }
            if (St(t)) {
        ...
        drop(t) {
            ...
            if (
                (null === (i = this.responder) || void 0 === i || i.setLocationRangeFromPointRange(o),
                null != n && n.length)
            )
                this.attachFiles(n);
            ...
            if (n) {
                ...
                if (t) {
                    ...
                    (!t.name && e && (t.name = "pasted-file-".concat(++dr, ".").concat(e)),
                        (i.type = "File"),
                        (i.file = t),
                        null === (b = this.delegate) || void 0 === b || b.inputControllerWillAttachFiles(),
                        null === (v = this.responder) || void 0 === v || v.insertFile(i.file),
                        this.requestRender(),
                        null === (A = this.delegate) || void 0 === A || A.inputControllerDidPaste(i));
                }
            }
            t.preventDefault();
        },
    ...
    const mr = (t) => {
            var e;
            return null === (e = t.type) || void 0 === e || null === (e = e.match(/\/(\w+)$/)) || void 0 === e
                ? void 0
                : e[1];
        },
    ...
    (Di(Ar, "events", {
        ...
        beforeinput(t) {
            const e = this.constructor.inputTypes[t.inputType],
                i =
                    ((n = t),
                    !(!/iPhone|iPad/.test(navigator.userAgent) || (n.inputType && "insertParagraph" !== n.inputType)));
            var n;
        ...
        Di(Ar, "inputTypes", {
                ...
                return (
                    ...
                    this.withTargetDOMRange(function () {
                        ...
                        this.deleteByDragRange =
                            null === (t = this.responder) || void 0 === t ? void 0 : t.getSelectedRange();
                    })
                );
            },
            ...
            insertFromPaste() {
                ...
                if (i) {
                    ...
                    ((n = o ? Vt(o).trim() : i),
                        ...
                        null === (r = this.delegate) || void 0 === r || r.inputControllerWillPaste(e),
                        this.withTargetDOMRange(function () {
                            var t;
                    ...
                    ((e.type = "text/plain"),
                        ...
                        null === (o = this.delegate) || void 0 === o || o.inputControllerWillPaste(e),
                        this.withTargetDOMRange(function () {
                            var t;
                    ...
                    ((e.type = "File"),
                        (e.file = t.files[0]),
                        null === (s = this.delegate) || void 0 === s || s.inputControllerWillPaste(e),
                        this.withTargetDOMRange(function () {
                            var t;
                    ...
                    (this.event.preventDefault(),
                        (e.type = "text/html"),
                        (e.html = n),
                        null === (a = this.delegate) || void 0 === a || a.inputControllerWillPaste(e),
                        this.withTargetDOMRange(function () {
                            var t;
                            return null === (t = this.responder) || void 0 === t ? void 0 : t.insertHTML(e.html);
                        }),
            ...
            insertText() {
                ...
                return this.insertString(
                    this.event.data ||
                        (null === (t = this.event.dataTransfer) || void 0 === t ? void 0 : t.getData("text/plain")),
                );
            },
            insertTranspose() {
                return this.insertString(this.event.data);
    ...
    const yr = function (t) {
        ...
        xr = (t) => {
            var e;
            return Array.from((null === (e = t.dataTransfer) || void 0 === e ? void 0 : e.types) || []).includes(
                "Files",
            );
        },
        Cr = (t) => {
            ...
            return (
                ...
                !((t) => {
                    ...
                    return (
                        ...
                        e.getData("text/html").includes("urn:schemas-microsoft-com:office:office")
                    );
                })(t)
            );
        },
        Er = function (t) {
            ...
            if (e) {
                return (
                    Array.from(e.types).filter((t) => t.match(/file/i)).length === e.types.length && e.files.length >= 1
                );
            }
        },
        Sr = function (t) {
        ...
        Fr = (t, e) => (e || (e = Mr(t)), t.querySelector("[data-trix-input][name='".concat(e, "']"))),
        Pr = (t) => t.getAttribute("data-trix-action"),
        Mr = (t) => t.getAttribute("data-trix-attribute") || t.getAttribute("data-trix-dialog-attribute");
    class Br extends q {
        constructor(t) {
            (super(t),
                (this.didClickActionButton = this.didClickActionButton.bind(this)),
                ...
                b("click", { onElement: this.element, matchingSelector: Lr, preventDefault: !0 }),
                b("click", { onElement: this.element, matchingSelector: Ir, withCallback: this.didClickDialogButton }),
                b("keydown", {
                    onElement: this.element,
                    matchingSelector: Or,
        ...
        eachActionButton(t) {
            return Array.from(this.element.querySelectorAll(wr)).map((e) => t(e, Pr(e)));
        }
        updateAttributes(t) {
        ...
        eachAttributeButton(t) {
            return Array.from(this.element.querySelectorAll(Tr)).map((e) => t(e, Mr(e)));
        }
        applyKeyboardCommand(t) {
            ...
            for (const t of Array.from(this.element.querySelectorAll("[data-trix-key]"))) {
                ...
                if (JSON.stringify(i.sort()) === e) return (v("mousedown", { onElement: t }), !0);
            }
            return !1;
        }
        dialogIsVisible(t) {
        ...
        setAttribute(t) {
            ...
            const i = Mr(t),
                n = Fr(t, i);
            return !n.willValidate || (n.setCustomValidity(""), n.checkValidity() && this.isSafeAttribute(n))
                ? (null === (e = this.delegate) || void 0 === e || e.toolbarDidUpdateAttribute(i, n.value),
                  this.hideDialog())
    ...
    class _r extends $n {
        constructor(t) {
            ...
            (super(...arguments),
                ...
                (this.inputController = 2 === _.getLevel() ? new Ar(this.editorElement) : new gr(this.editorElement)),
                (this.inputController.delegate = this),
                (this.inputController.responder = this.composition),
                (this.compositionController = new Xn(this.editorElement, this.composition)),
                (this.compositionController.delegate = this),
                (this.toolbarController = new Br(this.editorElement.toolbarElement)),
                (this.toolbarController.delegate = this),
                (this.editor = new Pn(this.composition, this.selectionManager, this.editorElement)),
        ...
        invokeAction(t, e) {
            return this.actionIsExternal(t)
                ...
                : null === (i = this.actions[t]) || void 0 === i || null === (i = i.perform) || void 0 === i
                  ? void 0
                  : i.call(this);
            var i;
        }
    ...
    var jr = Object.freeze({
        ...
        Wr = Object.freeze({ __proto__: null, MutationObserver: er, SelectionChangeObserver: Ot }),
        Ur = Object.freeze({ __proto__: null, FileVerificationOperation: nr, ImagePreloadOperation: Ui });
    vt(
        "trix-toolbar",
    ...
    const qr = function (t) {
            if (!t.hasAttribute("contenteditable"))
                return (
                    ...
                    })("focus", { onElement: t, withCallback: () => Hr(t) })
                );
        },
        Hr = function (t) {
            return (Jr(t), Kr(t));
    ...
    class ro extends HTMLElement {
        constructor() {
            (super(),
                ...
                Oi(this, no, this.constructor.formAssociated ? new $r(this) : new io(this)));
        }
        get trixId() {
            return this.hasAttribute("trix-id")
                ? this.getAttribute("trix-id")
                : (this.setAttribute("trix-id", ++zr), this.trixId);
        }
        get labels() {
        ...
        notify(t, e) {
            if (this.editorController) return v("trix-".concat(t), { onElement: this, attributes: e });
        }
        setFormValue(t) {
        ...
        connectedCallback() {
            this.hasAttribute("data-trix-internal") ||
                ...
                this.editorController ||
                    ...
                    (this.editorController = new _r({ editorElement: this, html: (this.defaultValue = this.value) })),
    ...
    const oo = {
        ...
        observers: Wr,
        operations: Ur,
        elements: Object.freeze({ __proto__: null, TrixEditorElement: ro, TrixToolbarElement: Vr }),
        filters: Object.freeze({ __proto__: null, Filter: In, attachmentGalleryFilter: On }),
    };
    return (
        Object.assign(oo, zn),
        (window.Trix = oo),
        setTimeout(function () {
            (customElements.get("trix-toolbar") || customElements.define("trix-toolbar", Vr),
                customElements.get("trix-editor") || customElements.define("trix-editor", ro));
        }, 0),
        oo
    );
});
