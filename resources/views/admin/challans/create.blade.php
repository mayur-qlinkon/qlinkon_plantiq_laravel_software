                ...
                <div class="p-6 grid grid-cols-1 md:grid-cols-4 gap-6">
                    ...
                    <div>
                        ...
                        <div @change="formData.challan_type = $event.target.value; handleTypeChange()">
                            <x-custom-select name="challan_type" placeholder="Select Type" :options="$typeLabels"
                                :selected="old('challan_type', '')" required />
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div @change="formData.direction = $event.target.value">
                            <x-custom-select name="direction" :options="['outward' => 'Outward (Dispatch)', 'inward' => 'Inward (Receipt)']" :selected="old('direction', 'outward')" required />
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div @change="formData.store_id = $event.target.value; autoSelectWarehouse()">
                            <x-custom-select name="store_id" placeholder="Select Store" :options="$storeOptions"
                                :selected="old('store_id', session('store_id', auth()->user()->store_id ?? ''))" required />
                        </div>
                    </div>
                    {{-- 🚀 STATUS SELECTION --}}
                    <div>
                        ...
                        <div @change="formData.status = $event.target.value">
                            {{-- Only branch transfers move stock. Labelling every type "Move Inventory"
                            told users their delivery challan was deducting stock when it was not. --}}
                    ...
                    <div>
                        ...
                        <div @change="formData.warehouse_id = $event.target.value">
                            <x-custom-select name="warehouse_id" placeholder="Select Warehouse" :options="$warehouseOptions"
                                :selected="old('warehouse_id', '')" required @set-warehouse.window="value = $event.detail" />
                        </div>
                    </div>
                    ...
                    <div x-show="formData.challan_type === 'branch_transfer'" x-transition.opacity x-cloak
                        ...
                        <div @change="formData.to_warehouse_id = $event.target.value">
                            <x-custom-select name="to_warehouse_id" placeholder="Select Destination"
                                :options="$toWarehouseOptions" :selected="old('to_warehouse_id', '')" @set-to-warehouse.window="value = $event.detail" />
                        </div>
                    </div>
