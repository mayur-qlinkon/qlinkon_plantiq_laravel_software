<x-mail.layout>
    <p style="margin:0 0 16px; font-size:15px; font-weight:800; color:#111827;">
        Work log from {{ $employeeName }}
    </p>

    <table role="presentation" cellpadding="0" cellspacing="0" style="width:100%; font-size:13px; color:#374151;">
        <tr>
            <td style="padding:6px 0; color:#6b7280;">Date</td>
            <td style="padding:6px 0; font-weight:700; text-align:right;">{{ $logDate }}</td>
        </tr>
        <tr>
            <td style="padding:6px 0; color:#6b7280;">Hours worked</td>
            <td style="padding:6px 0; font-weight:700; text-align:right;">{{ $hoursWorked }}</td>
        </tr>
    </table>

    <div style="margin:16px 0; padding:14px; background-color:#f9fafb; border-radius:8px;">
        <p style="margin:0 0 6px; font-size:11px; font-weight:700; color:#9ca3af; text-transform:uppercase;">Work
            described</p>
        <p style="margin:0; font-size:13px; line-height:1.6; color:#374151;">{{ $description }}</p>
    </div>
