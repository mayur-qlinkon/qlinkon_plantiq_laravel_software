...
@section('header', 'Create Plant Profile Tier')
    ...
    <div class="mx-auto">
        ...
        <div class="mb-8 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            <div>
                ...
                <h1 class="text-2xl font-extrabold text-gray-900 tracking-tight">New Plant Profile (Tier)</h1>
                <p class="text-sm text-gray-500 mt-1">Add a new capacity tier for nursery subscriptions.</p>
            </div>
            <button type="submit" form="create-tier-form" class="bg-brand-600 hover:bg-brand-700 text-white px-6 py-2.5 rounded-lg text-sm font-semibold transition-all shadow-md shadow-brand-500/20 flex items-center justify-center gap-2 self-start sm:self-end">
                <i class="fa-solid fa-floppy-disk"></i> Save Tier
            </button>
        </div>
        ...
        @if ($errors->any())
            <div class="mb-6 flex items-start gap-3 bg-red-50 border border-red-200 text-red-800 text-sm px-5 py-4 rounded-xl shadow-sm">
                ...
                <div>
                    <span class="font-bold">Could not save the profile tier. Please check the errors below:</span>
        ...
        <form id="create-tier-form" action="{{ route('platform.plant-profiles.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
                    ...
                    <div class="bg-white rounded-2xl shadow-sm border border-gray-200 p-6 sm:p-8">
                        ...
                        <div class="space-y-6">
                            ...
                            <div>
                                ...
                                <input type="text" name="name" value="{{ old('name') }}" required placeholder="e.g. 50 Plants" 
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-6 pt-2">
                                ...
                                <div>
                                    ...
                                    <input type="number" name="plant_limit" value="{{ old('plant_limit', 0) }}" required min="0" 
