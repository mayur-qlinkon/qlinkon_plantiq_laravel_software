        ...
        Alpine.data("inquiryForm", () => ({
            ...
            async submitInquiry() {
                ...
                try {
                    ...
                    const response = await fetch("<?php echo e(route('welcome.inquire')); ?>", {
                        method: "POST",
                        headers: {
...
<?php /**PATH C:\Users\qlinkongraphics\Desktop\MyLab\plantiq-local\resources\views/partials/inquiry-modal.blade.php ENDPATH**/ ?>