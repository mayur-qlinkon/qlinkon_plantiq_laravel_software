<?php $__env->startSection('title', 'Suppliers Management'); ?>
...
<?php $__env->startSection('content'); ?>
    <div class="pb-10" x-data="supplierCrud(<?php echo \Illuminate\Support\Js::from($suppliers->items())->toHtml() ?>)">
        ...
        <div class="bg-white rounded-t-xl shadow-sm border border-gray-100 p-4 border-b-0 mb-0">
            <form id="supplier-filter-form" method="GET" action="<?php echo e(route('admin.suppliers.index')); ?>"
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.custom-select','data' => ['name' => 'status','placeholder' => 'All Status','options' => ['active' => 'Active', 'inactive' => 'Inactive'],'selected' => ''.e(request('status')).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['name' => 'status','placeholder' => 'All Status','options' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(['active' => 'Active', 'inactive' => 'Inactive']),'selected' => ''.e(request('status')).'']); ?>
...
<?php endif; ?>
                    ...
                    <div class="w-full sm:w-[170px] shrink-0">
                        <?php if (isset($component)) { $__componentOriginalc933793160c9c2655e76e4334d02687c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalc933793160c9c2655e76e4334d02687c = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.custom-select','data' => ['name' => 'registration_type','placeholder' => 'All GST Types','options' => [
                            'regular' => 'Regular',
                            'composition' => 'Composition',
                            'unregistered' => 'Unregistered',
                            'overseas' => 'Overseas',
                        ],'selected' => ''.e(request('registration_type')).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('custom-select'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => 'registration_type','placeholder' => 'All GST Types','options' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute([
                            'regular' => 'Regular',
                            'composition' => 'Composition',
                            'unregistered' => 'Unregistered',
                            'overseas' => 'Overseas',
                        ]),'selected' => ''.e(request('registration_type')).'']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalc933793160c9c2655e76e4334d02687c)): ?>
<?php $attributes = $__attributesOriginalc933793160c9c2655e76e4334d02687c; ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.import-modal','data' => ['type' => 'suppliers','triggerClass' => 'bg-white border border-gray-200 text-gray-700 hover:bg-gray-50 px-3 md:px-4 py-2.5 rounded-lg text-sm font-bold transition-colors shadow-sm flex items-center gap-1.5 whitespace-nowrap']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['type' => 'suppliers','triggerClass' => 'bg-white border border-gray-200 text-gray-700 hover:bg-gray-50 px-3 md:px-4 py-2.5 rounded-lg text-sm font-bold transition-colors shadow-sm flex items-center gap-1.5 whitespace-nowrap']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
                            ...
                            <tr class="hover:bg-gray-50/50 transition-colors group">
                                ...
                                <td class="px-6 py-4">
                                    <div class="flex items-center justify-end gap-2 transition-opacity">
                                        <button @click="openViewModal(<?php echo e($supplier->toJson()); ?>)"
                ...
                <?php $__empty_1 = true; $__currentLoopData = $suppliers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $supplier): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="p-4 hover:bg-gray-50/50 transition-colors flex flex-col gap-3">
                            ...
                            <div class="flex items-center gap-3 min-w-0">
                                ...
                                <div class="min-w-0">
                                    ...
                                    <p class="text-[11px] text-gray-500 mt-0.5 truncate">
                                        <?php echo e($supplier->email ?? 'No email added'); ?></p>
                                </div>
                            </div>
                            <div class="shrink-0">
                                <?php if($supplier->is_active): ?>
                        ...
                        <div class="flex items-center justify-end gap-2 pt-1 border-t border-gray-50 mt-1">
                            <button type="button" @click="openViewModal(<?php echo e($supplier->toJson()); ?>)"
                                class="w-8 h-8 rounded-lg bg-gray-50 text-gray-500 hover:bg-gray-100 hover:text-gray-700 flex items-center justify-center transition-colors"
                                title="View Details">
                                <i data-lucide="eye" class="w-4 h-4"></i>
                            </button>
                            ...
                            <?php if(has_permission('suppliers.update')): ?>
                                <button type="button" @click="openEditModal(<?php echo e($supplier->toJson()); ?>)"
                                    class="w-8 h-8 rounded-lg bg-blue-50 text-blue-600 hover:bg-blue-100 hover:text-blue-700 flex items-center justify-center transition-colors"
                                    title="Edit">
                                    <i data-lucide="pencil" class="w-4 h-4"></i>
                                </button>
                            ...
                            <div>
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-3 gap-5 mb-5 items-end">
                                    <div class="w-full shrink-0">
                                        ...
                                        <?php if (isset($component)) { $__componentOriginalc933793160c9c2655e76e4334d02687c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalc933793160c9c2655e76e4334d02687c = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.custom-select','data' => ['name' => 'registration_type','id' => 'modal-supplier-registration-type','placeholder' => 'Select Type','options' => [
                                                'regular' => 'Regular',
                                                'composition' => 'Composition',
                                                'unregistered' => 'Unregistered',
                                                'sez' => 'SEZ',
                                                'overseas' => 'Overseas',
                                            ],'selected' => '']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('custom-select'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => 'registration_type','id' => 'modal-supplier-registration-type','placeholder' => 'Select Type','options' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute([
                                                'regular' => 'Regular',
                                                'composition' => 'Composition',
                                                'unregistered' => 'Unregistered',
                                                'sez' => 'SEZ',
...
<?php endif; ?>
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-3 gap-5 mb-5 items-end">
                                    ...
                                    <div class="w-full shrink-0">
                                        ...
                                        <?php if (isset($component)) { $__componentOriginalc933793160c9c2655e76e4334d02687c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalc933793160c9c2655e76e4334d02687c = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.custom-select','data' => ['name' => 'state_id','id' => 'modal-supplier-state-id','placeholder' => 'Select State','options' => collect($states ?? [])
                                                ->pluck('name', 'id')
                                                ->toArray(),'selected' => '']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('custom-select'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => 'state_id','id' => 'modal-supplier-state-id','placeholder' => 'Select State','options' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(collect($states ?? [])
                                                ->pluck('name', 'id')
                                                ->toArray()),'selected' => '']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
                            ...
                            <div>
                                ...
                                <div
                                    ...
                                    <div class="w-full shrink-0">
                                        ...
                                        <?php if (isset($component)) { $__componentOriginalc933793160c9c2655e76e4334d02687c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalc933793160c9c2655e76e4334d02687c = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.custom-select','data' => ['name' => 'balance_type','id' => 'modal-supplier-balance-type','placeholder' => 'Select Balance Type','options' => [
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => 'balance_type','id' => 'modal-supplier-balance-type','placeholder' => 'Select Balance Type','options' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute([
                                                'payable' => 'Payable (We owe)',
                                                'advance' => 'Advance (They owe)',
                                            ]),'selected' => '']); ?>
<?php echo $__env->renderComponent(); ?>
        ...
        function supplierCrud(allSuppliersData) {
            return {
                ...
                exportPDF() {
                    ...
                    const form = document.getElementById('supplier-filter-form');
                    const url = new URL('<?php echo e(route('admin.suppliers.download-pdf')); ?>', window.location.origin);
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\qlinkongraphics\Desktop\MyLab\plantiq-local\resources\views/admin/suppliers/index.blade.php ENDPATH**/ ?>