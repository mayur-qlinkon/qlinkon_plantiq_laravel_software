        ...
        <button @click="open = !open"
            ...
            <div class="w-full h-full flex items-center justify-center">
                ...
                <div x-show="!open" class="w-12 h-12 sm:w-14 sm:h-14 lg:w-16 lg:h-16 animate-core-float">
                    <img src="<?php echo e(asset('assets/icons/chatbot.png')); ?>" alt="AI" class="w-full h-full object-contain filter drop-shadow-[0_4px_12px_rgba(0,0,0,0.15)]">
                </div>
...
window.aiChatbot = function () {
    return {
        ...
        urls: {
            chat:          '<?php echo e(route("admin.ai-chatbot.chat")); ?>',
            usage:         '<?php echo e(route("admin.ai-chatbot.usage")); ?>',
            conversations: '<?php echo e(route("admin.ai-chatbot.conversations")); ?>',
        },
...
</script><?php /**PATH C:\Users\qlinkongraphics\Desktop\MyLab\plantiq-local\resources\views/components/modals/ai-chatbot-popup.blade.php ENDPATH**/ ?>